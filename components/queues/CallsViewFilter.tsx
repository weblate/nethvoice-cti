...
import { DEFAULT_OUTCOME_FILTER, getFilterValues } from '../../lib/queues'
...
export const CallsViewFilter = forwardRef<HTMLButtonElement, CallsViewFilterProps>(
  (
    { queues, updateTextFilter, updateOutcomeFilter, updateQueuesFilter, className, ...props },
    ref,
  ) => {
    ...
    function changeTextFilter(event: any) {
      ...
      // update queues (notify parent component)
    ...
    function changeOutcome(event: any) {
    ...
    useEffect(() => {
      ...
      //// TODO setQueues(filterValues.queues)

      updateOutcomeFilter(filterValues.outcome)

      //// TODO updateQueuesFilter
    }, [])
    ...
    const resetFilters = () => {
      ...
      //// TODO ? savePreference('queuesQueuesFilter', ...)

      // notify parent component
      updateTextFilter('')
      updateOutcomeFilter(DEFAULT_OUTCOME_FILTER)
