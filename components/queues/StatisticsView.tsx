...
import { retrieveQueueStats } from '../../lib/queues'
...
export const StatisticsView: FC<StatisticsViewProps> = ({
  ...
  useEffect(() => {
    ...
    fetchStats()
  }, [firstRender, isStatsLoaded, stats])
    ...
    <div className={classNames(className)}>
      ...
      <div className='mx-auto'>
        ...
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center'>
          ...
          <Button variant='white' className='mb-4'>
            <FontAwesomeIcon
              icon={faDownload}
        ...
        <ul role='list' className='grid grid-cols-1 gap-6 md:grid-cols-2 2xl:grid-cols-3 text-sm'>
          {/* skeleton */}
                  ...
                  <li className='col-span-1 rounded-lg divide-y shadow divide-gray-200 bg-white text-gray-700'>
                    ...
                    <div className='flex justify-between items-center px-5 py-4 space-x-4'>
                      <div className='flex overflow-hidden items-center space-x-2'>
                        <h3 className='truncate text-base leading-6 font-medium'>{queue.name}</h3>
